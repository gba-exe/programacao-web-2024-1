...
public class UsuarioControllerTests {
    ...
    class Get {
        ...
        class BuscaPorId {
            ...
            void quandoOIdNaoExisteEntaoRetornaStatus404() throws Exception {
                ...
                mockMvc.perform(get("/usuarios/4242"))
    ...
    class Post {
        ...
        @Test
        @DisplayName("Quando o e-mail contém menos que 10 caracteres, então retorna status 400")
    ...
    class Put {
        ...
        @Test
        @DisplayName("Quando o ID existe, e email possui menos de 10 caracteres, então retorna status 400")
